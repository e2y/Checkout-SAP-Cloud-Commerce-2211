...
describe(`CheckoutComStepsSetGuard`, () => {
  ...
  let checkoutComFlowService: CheckoutComFlowService;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [
        ...
        {
          provide: CheckoutComFlowService,
    ...
    checkoutComFlowService = TestBed.inject(CheckoutComFlowService);
    checkoutComBillingAddressFormFacade = TestBed.inject(CheckoutComBillingAddressFormFacade);
  });

  describe('Checkout flow disabled', () => {
    beforeEach(() => {
      spyOn(checkoutComFlowService, 'requestIsFlowEnabled').and.returnValue(
        of({
          loading: false,
          data: { enabled: false },
          error: false
