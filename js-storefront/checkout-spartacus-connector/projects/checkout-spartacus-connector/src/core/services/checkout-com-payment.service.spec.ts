...
import { address } from '@spartacus/assets/translations/en/address';
...
describe('CheckoutComPaymentService', () => {
  ...
  describe('Payment details', () => {
    ...
    it('should dispatch update payment details', () => {
      service.updatePaymentDetails(paymentDetails);
      ...
      expect(checkoutComStore.dispatch).toHaveBeenCalledWith(
        new CheckoutComActions.CheckoutUpdatePaymentDetails({
          paymentDetails,
          userId
        })
      );
