...
const projectOccIsABC = (state: CheckoutComState) => state.isABC;
...
const projectAchLinkToken = (state: CheckoutComState) => state.achLinkToken;
const projectAchOrderSuccess = (state: CheckoutComState) => state.achSuccessOrder;

const achPlaidLinkMetaData = (state: CheckoutComState) => state.achPlaidLinkMetaData;
...
export const getOccIsABC: MemoizedSelector<StateWithCheckoutCom,
  boolean> = createSelector(getCheckoutComState, projectOccIsABC);
...
export const getAchLinkToken: MemoizedSelector<
  StateWithCheckoutCom, string> = createSelector(getCheckoutComState, projectAchLinkToken);

export const getAchOrderSuccess: MemoizedSelector<
  StateWithCheckoutCom, AchSuccessOrder> = createSelector(getCheckoutComState, projectAchOrderSuccess);

export const PlaidLinkMetadata: MemoizedSelector<
  StateWithCheckoutCom, AchSuccessMetadata> = createSelector(getCheckoutComState, achPlaidLinkMetaData);
