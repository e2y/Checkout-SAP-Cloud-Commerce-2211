...
import { CHECKOUT_UPDATE_PAYMENT_DETAILS, CheckoutComAction } from './checkout-com.actions';
...
export const initialState: CheckoutComState = {
  ...
  isABC: null,
  achLinkToken: null,
  achSuccessOrder: null,
  achPlaidLinkMetaData: {},
};
...
export function reducer(state = initialState,
  ...
  switch (action.type) {
    ...
    case CheckoutComActions.SET_OCC_IS_ABC_SUCCESS:
      return {...state, isABC: action.payload};
    ...
    case CheckoutComActions.CHECKOUT_UPDATE_PAYMENT_DETAILS_SUCCESS: {
      return {
        ...state,
    ...
    case CheckoutComActions.SET_ACH_LINK_TOKEN:
      return {...state, achLinkToken: null};
    case CheckoutComActions.SET_ACH_LINK_TOKEN_SUCCESS:
      return {...state, achLinkToken: action.payload};
    case CheckoutComActions.SET_ACH_LINK_TOKEN_FAIL:
      return {...state, achLinkToken: null};

    case CheckoutComActions.SET_ACH_SUCCESS_ORDER:
      return {...state, achSuccessOrder: null};
    case CheckoutComActions.SET_ACH_SUCCESS_ORDER_SUCCESS:
      return {...state, achSuccessOrder: {order: action.payload, error: null}};
    case CheckoutComActions.SET_ACH_SUCCESS_ORDER_FAIL:
      return {...state, achSuccessOrder: {order: null, error: action.payload}};

    case CheckoutComActions.SET_ACH_SET_ACCOUNT_LIST_SUCCESS:
      return {...state, achPlaidLinkMetaData: action.payload};
    case CheckoutComActions.SET_ACH_SET_ACCOUNT_LIST_FAIL:
      return {...state, achPlaidLinkMetaData: null};
  }
