...
import { CheckoutComFlowUIConfigurationData, CheckoutComPaymentSession } from '../interfaces';
 ...
 * @since 2211.32.1
 */
export class CheckoutComClearPaymentSessionEvent extends CxEvent {
  static override readonly type: string = 'CheckoutComClearPaymentSessionEvent';
}
