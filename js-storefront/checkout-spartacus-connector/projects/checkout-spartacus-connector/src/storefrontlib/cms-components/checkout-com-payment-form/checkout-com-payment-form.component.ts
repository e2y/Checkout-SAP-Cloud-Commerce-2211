...
export class CheckoutComPaymentFormComponent extends CheckoutPaymentFormComponent implements OnInit, OnDestroy {
  ...
  override billingAddressForm: UntypedFormGroup = this.billingAddressService.getBillingAddressForm();
  protected logger: LoggerService = inject(LoggerService);
  protected editModeEnabled$: Observable<boolean> = this.billingAddressService.isEditModeEnabled();
   ...
   *
   * @param {CheckoutComPaymentFacade} checkoutPaymentFacade - The checkout payment facade service.
