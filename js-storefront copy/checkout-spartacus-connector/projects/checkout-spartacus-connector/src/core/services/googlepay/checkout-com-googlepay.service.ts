...
import { CheckoutComGooglepayConnector } from '../../connectors/checkout-com-googlepay/checkout-com-googlepay.connector';
import { CheckoutComReloadGooglePaymentEvent, CheckoutComResetGooglePaymentEvent } from '../../events/google-pay.events';
import { CheckoutComGooglepayFacade } from '../../facades/checkout-com-googlepay.facade';
import {
...
export class CheckoutComGooglepayService extends OrderService implements CheckoutComGooglepayFacade {
   ...
   * @returns {GooglePayPaymentDataRequest} - The initial Google Pay payment request object.
   * @since 2211.31.1
   */
   ...
   *
   * @param {GooglePayMerchantConfiguration} merchantConfiguration - The Google Pay merchant configuration.
   * @returns {GooglePayPaymentRequest} - The full Google Pay payment request object.
   * @since 2211.31.1
   */
  createFullPaymentRequest(merchantConfiguration: GooglePayMerchantConfiguration): GooglePayPaymentDataRequest {
    return {
      apiVersion: 2,
      apiVersionMinor: 0,
      allowedPaymentMethods: [
   ...
   */
  addPaymentExpressIntents(paymentRequest: GooglePayMerchantConfiguration): Observable<GooglePayPaymentExpressIntents> {
    return of({
      ...paymentRequest,
   ...
   * @since 2211.31.1
   */
  onPaymentAuthorized(paymentData: GooglePayPaymentRequest): Observable<GooglePaySession> {
   ...
   * @since 2211.31.1
   */
  onPaymentDataChanged(paymentData: IntermediatePaymentData): Observable<any> {
