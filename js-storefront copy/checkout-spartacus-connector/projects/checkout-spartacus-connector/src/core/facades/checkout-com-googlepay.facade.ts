...
import { GooglePayMerchantConfiguration, GooglePayPaymentDataRequest, GooglePayPaymentExpressIntents, GooglePayPaymentRequest, IntermediatePaymentData } from '../model/GooglePay';
...
export abstract class CheckoutComGooglepayFacade extends OrderFacade {
  ...
  abstract createInitialPaymentRequest(merchantConfiguration: GooglePayMerchantConfiguration, shippingAddressRequired: boolean,): any | GooglePayPaymentDataRequest;
   ...
   */
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  abstract createFullPaymentRequest(merchantConfiguration: GooglePayMerchantConfiguration): any | GooglePayPaymentDataRequest;
   ...
   */
  abstract addPaymentExpressIntents(paymentRequest: GooglePayMerchantConfiguration): Observable<GooglePayPaymentExpressIntents>;
   ...
   */
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  abstract onPaymentAuthorized(paymentData: GooglePayPaymentRequest): Observable<any>;
   ...
   */
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  abstract onPaymentDataChanged(paymentData: IntermediatePaymentData): Observable<any>;
}
