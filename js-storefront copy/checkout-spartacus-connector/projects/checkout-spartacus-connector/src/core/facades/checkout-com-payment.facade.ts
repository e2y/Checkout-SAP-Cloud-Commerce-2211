...
export abstract class CheckoutComPaymentFacade extends CheckoutPaymentFacade {
   ...
   * @returns {Observable<string>} - An observable containing the merchant key.
   * @since 2211.32.1
   */
   ...
   *
   * Determines whether the current user is allowed to save their card details
   * for future transactions. This is typically based on user preferences and
   * business rules configured in the system.
   *
   * @returns {Observable<boolean>} - Returns true if the card can be saved, false otherwise.
   * @since 2211.30.1
   */
