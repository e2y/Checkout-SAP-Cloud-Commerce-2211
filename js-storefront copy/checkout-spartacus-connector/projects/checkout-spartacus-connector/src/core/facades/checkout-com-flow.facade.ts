...
import { CheckoutComFlowUIConfigurationData, CheckoutComPaymentDetails, FlowEnabledDataResponseDTO } from '../interfaces';
...
export abstract class CheckoutComFlowFacade extends CheckoutComPaymentFacade {
   ...
   */
  abstract initializeFlow(): Observable<boolean>;
   ...
   * @since 2211.31.1
   */
  abstract getFlowUIConfiguration(): Observable<CheckoutComFlowUIConfigurationData>;
  ...
  abstract clearPaymentSession(): void;
}
