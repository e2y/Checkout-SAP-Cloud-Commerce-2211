...
import { CheckoutComApplePayPaymentRequestEvent } from '../../../../core/events/apple-pay.events';
import { CheckoutComApplepayFacade } from '../../../../core/facades/checkout-com-applepay.facade';
import { CheckoutComOrderFacade } from '../../../../core/facades/checkout-com-order.facade';
import { ApplePayAuthorization, ApplePayPaymentRequest, ApplePayShippingContactUpdate, ApplePayShippingMethodUpdate } from '../../../../core/model/ApplePay';
...
export class CheckoutComApmApplepayComponent implements OnInit {
  ...
  getDeliveryAddressUpdate(): void {
    ...
    this.checkoutComApplepayFacade.getDeliveryAddressUpdateFromState().pipe(
  ...
  getDeliveryMethodUpdate(): void {
    ...
    this.checkoutComApplepayFacade.getDeliveryMethodUpdateFromState().pipe(
