...
class MockCheckoutComProgressService {
  steps$ = of(mockCheckoutSteps);
  activeStepIndex$ = of(0);
}
...
describe('CheckoutComCheckoutProgressComponent', () => {
  let component: CheckoutComCheckoutProgressComponent;
  let fixture: ComponentFixture<CheckoutComCheckoutProgressComponent>;
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
        ...
        providers: [
          ...
          {
            provide: CheckoutComProgressService,
            useClass: MockCheckoutComProgressService,
          },
          {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CheckoutComCheckoutProgressComponent);
