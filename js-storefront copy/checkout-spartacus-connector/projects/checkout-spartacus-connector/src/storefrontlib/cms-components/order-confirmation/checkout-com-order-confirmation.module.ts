...
import { CheckoutComOrderConfirmationGuard } from '../../../core/guards/checkout-com-order-confirmation.guard';
import { CheckoutComCartSharedModule } from '../checkout-com-cart-shared/checkout-com-cart-shared.module';
import { CheckoutComOrderOverviewComponent } from '../checkout-com-order-overview/checkout-com-order-overview.component';
import { CheckoutComOrderDetailBillingComponent } from '../order-details/checkout-com-order-detail-billing/checkout-com-order-detail-billing.component';
import { CheckoutComOrderDetailBillingModule } from '../order-details/checkout-com-order-detail-billing/checkout-com-order-detail-billing.module';
import { CheckoutComOrderConfirmationItemsComponent } from './checkout-com-order-confirmation-items/checkout-com-order-confirmation-items.component';
import { CheckoutComOrderConfirmationShippingComponent } from './checkout-com-order-confirmation-shipping/checkout-com-order-confirmation-shipping.component';
