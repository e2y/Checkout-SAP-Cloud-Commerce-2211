...
import { getUserIdCartId } from '../../../../../checkout-spartacus-connector/src/core/shared/get-user-cart-id';
...
export class ExpressAddToCartComponent extends AddToCartComponent implements OnDestroy {
   ...
   * @param {CheckoutComApplepayFacade} checkoutComApplepayFacade - Service to manage Apple Pay.
   * @param {CheckoutComGooglepayFacade} checkoutComGooglePayFacade - Service to manage Google Pay.
   */
  constructor(
