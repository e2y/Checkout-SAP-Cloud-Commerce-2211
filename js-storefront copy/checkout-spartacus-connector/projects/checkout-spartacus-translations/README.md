...
* Translations package `@checkout.com/checkout-spartacus-translations`: version 2211.43.0
* Connector package `@checkout.com/checkout-spartacus-connector`: version 2211.43.0
* Spartacus: version 2211.43.0
* SAP Commerce Cloud: version 2211
* [Angular CLI](https://angular.dev/): Version 19.2.20 is required (aligned with `@angular/cli` ^19.2.20).
* [Node.js](https://nodejs.org/en): Version 20.9.0+ is required (20.x recommended).
...
- For full integration and configuration, see the main connector [README](../checkout-spartacus-connector/README.md).
...
- Translations: `@checkout.com/checkout-spartacus-translations` **2211.43.0**
- Connector: `@checkout.com/checkout-spartacus-connector` **2211.43.0**
- Spartacus: **2211.43.0**
...
See the changelog in the main connector [README](../checkout-spartacus-connector/README.md).
