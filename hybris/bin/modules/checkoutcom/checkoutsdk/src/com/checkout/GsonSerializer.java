...
public class GsonSerializer implements Serializer {
    ...
    private static final Gson DEFAULT_GSON = new GsonBuilder()
            ...
            // Java Time type adapters (FIX for Java 17+ reflection issues)
            ...
            .registerTypeAdapter(LocalDate.class, (JsonDeserializer<LocalDate>) (json, type, context) ->
                    json == null || json.getAsString().isEmpty() ? null : LocalDate.parse(json.getAsString()))

            .registerTypeAdapter(LocalDateTime.class, (JsonSerializer<LocalDateTime>) (date, type, context) ->
                    date == null ? null : new JsonPrimitive(date.toString()))
            .registerTypeAdapter(LocalDateTime.class, (JsonDeserializer<LocalDateTime>) (json, type, context) ->
                    json == null || json.getAsString().isEmpty() ? null : LocalDateTime.parse(json.getAsString()))

            .registerTypeAdapter(Instant.class, (JsonDeserializer<Instant>) (json, type, context) ->
                    json == null || json.getAsString().isEmpty() ? null : Instant.parse(json.getAsString()))
