...
public class DefaultCheckoutComFlowBillingAddressPopulatorTest {
    ...
    @Spy
    @InjectMocks
    private DefaultCheckoutComFlowBillingAddressPopulator testObj;
    ...
    @Mock
    private BillingInformation billingMock;

    @Mock
    private Address addressMock;

    @Test
    public void populate_shouldPopulateBilling_whenPaymentAddressExists() {

        when(cartModelMock.getPaymentAddress()).thenReturn(addressModelMock);
        doReturn(billingMock).when(testObj).createBillingAddress(addressModelMock);

        testObj.populate(cartModelMock, paymentSessionRequestBuilderMock);

        verify(paymentSessionRequestBuilderMock).billing(billingMock);
    }


    @Test
    public void createBillingAddress_shouldCreateBillingWithAddressAndPhone_whenPaymentAddressContainsPhone() {
        ...
        final BillingInformation result = testObj.createBillingAddress(addressModelMock);
