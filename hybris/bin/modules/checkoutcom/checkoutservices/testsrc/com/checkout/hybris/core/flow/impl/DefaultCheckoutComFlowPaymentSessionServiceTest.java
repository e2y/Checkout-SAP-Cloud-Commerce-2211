...
class DefaultCheckoutComFlowPaymentSessionServiceTest {
    ...
    @Captor
    private ArgumentCaptor<PaymentSessionCreateRequest> paymentSessionResponseArgumentCaptor;
    ...
    void createPaymentSession_shouldReturnCreatedPaymentSession_whenCartHasSessionCart() throws ExecutionException, InterruptedException {
        ...
        when(flowClientMock.requestPaymentSession(any(PaymentSessionCreateRequest.class))).thenReturn(completableFuturePaymentSessionResponseMock);
        ...
        final PaymentSessionCreateRequest paymentSessionRequest = paymentSessionResponseArgumentCaptor.getValue();
